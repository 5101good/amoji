...
import { API_VERSION, DATABASE_VERSION, PACKS_CAPABILITY, LIBRARY_MANAGEMENT_CAPABILITY, CREATE_DRAFT_CAPABILITY, TEXT_SUGGESTION_CAPABILITY, DSH_NATIVE_CAPABILITY } from '../dist/src/shared-contract.js';
...
await writeFile(`${out}/BUILD.json`, JSON.stringify({ dshVersion: '0.1.5-rc.2', serviceApi: API_VERSION, databaseVersion: DATABASE_VERSION, providedManagementCapabilities: [PACKS_CAPABILITY, LIBRARY_MANAGEMENT_CAPABILITY, CREATE_DRAFT_CAPABILITY, TEXT_SUGGESTION_CAPABILITY], requiredCapabilities: [DSH_NATIVE_CAPABILITY, LIBRARY_MANAGEMENT_CAPABILITY, PACKS_CAPABILITY], clientSha256: hash, node: process.version, validation: 'published npm contracts and local lifecycle tests; live QA tracked separately' }, null, 2) + '\n');
