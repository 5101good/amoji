...
import { API_VERSION, CLAUDE_TICKET_CAPABILITY } from '../dist/src/shared-contract.js';
...
await writeFile(`${destination}/BUILD.json`, JSON.stringify({
  ...
  serviceApi: API_VERSION, requiredCapabilities: [CLAUDE_TICKET_CAPABILITY], minimumClaudeCode: '2.1.196',
