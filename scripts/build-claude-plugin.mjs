...
import { DATABASE_VERSION, CREATE_DRAFT_CAPABILITY, TEXT_SUGGESTION_CAPABILITY, API_VERSION, CLAUDE_TICKET_CAPABILITY } from '../dist/src/shared-contract.js';
...
await writeFile(`${destination}/BUILD.json`, JSON.stringify({
  ...
  serviceApi: API_VERSION, databaseVersion: DATABASE_VERSION, providedManagementCapabilities: [CREATE_DRAFT_CAPABILITY, TEXT_SUGGESTION_CAPABILITY], requiredCapabilities: [CLAUDE_TICKET_CAPABILITY], minimumClaudeCode: '2.1.196',
