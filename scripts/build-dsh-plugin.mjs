...
import { API_VERSION, DATABASE_VERSION, CREATE_DRAFT_CAPABILITY, DSH_SUBMISSION_CAPABILITY } from '../dist/src/shared-contract.js';
...
for (const name of ['adapter-runtime', 'shared-client', 'shared-contract', 'shared-service', 'claude-tickets', 'library-store', 'sample-catalog', 'media', 'drafts', 'panel-server', 'projection', 'search', 'service-main']) await cp(`${root}/dist/src/${name}.js`, `${out}/runtime/src/${name}.js`);
